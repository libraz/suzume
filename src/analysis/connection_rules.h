...
enum class ConnectionPattern {
  ...
  ShimauAuxAfterTeForm,    // テ形動詞 → しまう/しまった (AUX) (completive/regretful)
  ...
  OnbinkeiToVoicedTa,         // VERB(onbinkei) → だ(AUX) (voiced past tense: 泳いだ = 泳い + だ)
  OnbinkeiToTara,             // VERB(onbinkei) → たら/だら(AUX) (conditional: 書いたら = 書い + たら)
  OnbinkeiToTa,               // VERB(onbinkei) → た(AUX) (past: 書いた = 書い + た)
